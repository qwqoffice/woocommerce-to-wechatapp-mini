	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new W2W_WxPayException("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new W2W_WxPayException("xml数据异常！");
		}
        //将XML转为array
        //禁止引用外部xml实体
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
		$string = $string . "&key=".W2W_WxPayConfig::get_key();
		//签名步骤三：MD5加密
		$string = md5($string);
		//签名步骤四：所有字符转为大写
 ...
 *
 */
class W2W_WxPayResults extends W2W_WxPayDataBase
{
	/**
	 * 
	 * 检测签名
	...
	public function CheckSign()
	{
		//fix异常
		if(!$this->IsSignSet()){
			throw new W2W_WxPayException("签名错误！");
		}
 ...
 *
 */
class W2W_WxPayNotifyReply extends  W2W_WxPayDataBase
{
	/**
	 * 
 ...
 *
 */
class W2W_WxPayUnifiedOrder extends W2W_WxPayDataBase
{	
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayOrderQuery extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayCloseOrder extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayRefund extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayRefundQuery extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayDownloadBill extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayReport extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayShortUrl extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayMicroPay extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayReverse extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayJsApiPay extends W2W_WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class W2W_WxPayBizPayUrl extends W2W_WxPayDataBase
{
		/**
	* 设置微信分配的公众账号ID
	* @param string $value 
